...
tpm300a_v1_2_ns = cg.esphome_ns.namespace('tpm300a_v1_2')

CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(tpm300a_v1_2_ns.class_('TPM300AV12Component', cg.PollingComponent, uart.UARTDevice)),
